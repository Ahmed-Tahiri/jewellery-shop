...
export let FormNumInputComponent = ({ data, error = null, label, name, id, placeholder, inputChangeHandler, pattern }) => {
    return (<>
...
export const FormNumInput = React.memo(FormNumInputComponent);