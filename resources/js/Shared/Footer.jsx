...
export let Footer = () => {
    ...
    return <footer className="w-full bg-powder-gray flex items-center justify-center p-5">
        <div className="bg-white w-full flex items-center justify-center px-15">
