...
export let SecondaryImgCard = ({ setCanEdit, file, onImageChange, onImageDelete }) => {
            ...
            {preview && (
                <div className="w-full flex flex-row justify-between gap-x-1.5">
                    <form encType="multipart/form-data" className="flex items-center justify-center">
                        ...
                        <input type="file" accept="image/*" id="image-edit" className="hidden" onChange={handleFileChange} />
                    </form>
