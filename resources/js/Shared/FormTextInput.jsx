...
let FormTextInputComponent = ({ data, error = null, label, name, id, placeholder, type, inputChangeHandler }) => {
    return (<>
...
export const FormTextInput = React.memo(FormTextInputComponent);