...
export default function Show({ discount, percentage }) {
            ...
            <div className="w-full flex flex-col gap-y-8">
                <div className="w-full flex flex-row justify-between items-center">
                    ...
                    <div className="flex flex-row items-center justify-end">
                        <Link className="flex items-center justify-center font-poppins text-base bg-light-gray text-white p-2 min-w-24" href={route("admin.discounts")} >Back</Link>
                    </div>
                </div>
                ...
                <div className="w-full flex gap-5 flex-row items-start justify-between">
                        ...
                        <div className="w-full flex flex-col items-start gap-y-4">
                            ...
                            <div className="w-full flex flex-row gap-x-5 justify-between items-center border-1 border-gray-300 rounded p-2 ">
                                <div className="flex flex-col w-full  py-2 px-3 gap-y-2">
                                    ...
                                    <ItemData heading={'Code:'} data={discount.code} />
                            ...
                            <div className="w-full flex gap-x-2 justify-end">
                                <Link href={route('admin.discounts.edit', discount.id)} className="min-w-25  font-poppins p-2 bg-zinc text-white text-center shadow-sm cursor-pointer  hover:bg-zinc-dark transition-colors ease-linear duration-200">Edit</Link>
                    ...
                    <div className="w-3/10 p-5 bg-white rounded shadow flex flex-col gap-y-3">
                        <div className="w-full h-80">
                            <PieChart percentage={percentage} category={discount} />
                        </div>
                    </div>
                </div>
            </div>
