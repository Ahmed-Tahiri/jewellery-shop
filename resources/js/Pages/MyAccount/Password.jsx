            ...
            <form onSubmit={formSubmitHandler} className="w-full flex flex-col items-start gap-y-4">
                <div className="flex flex-col items-start w-full gap-y-3">
                    ...
                    <div className="w-full flex justify-end">
                        <Link href={'/myaccount/password/forgot'} className="font-poppins text-sm font-semibold text-zinc underline hover:text-zinc-dark active:text-mustard">Forgot Password?</Link>
                    </div>
