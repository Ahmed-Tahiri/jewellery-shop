        ...
        <AuthLayout heading='Sign Up' description="Complete the signup form to create your account and discover jewellery that suits your style.">
            <div className="w-full flex flex-col">
                <form className="w-full flex flex-col gap-y-5" onSubmit={submitHandler}>
                    ...
                    <div className="flex flex-col lg:flex-col md:flex-row xl:flex-row gap-x-10 gap-y-5">
                ...
                <div className="w-full text-center mt-3"><p className="font-poppins text-sm md:text-base text-semi-black font-medium">Already have an account? <Link href={route('signin')} className="text-zinc underline hover:cursor-pointer hover:font-semibold active:text-mustard">Sign In</Link></p></div>
            </div>
        </AuthLayout>
    );
}