...
export let NewArrivalJewelleryCard = () => {
    ...
    return (<div className="flex-1 flex flex-row gap-x-3 p-2 shadow-xs border-[0.5px] border-gray-300">
        <Link href={'/'} className="w-[45%] aspect-square bg-powder-gray relative shadow-xs rounded-xs">
        ...
        <div className="flex flex-col w-[55%] gap-y-2 items-start py-6">
            ...
            <p className="font-poppins text-dark-gray text-[15px]">Handcrafted bracelet designed to sparkle with modern beauty and tradition.</p>
            <Link className="mt-5 flex w-full flex-row gap-x-2 items-center justify-start font-poppins text-zinc font-medium hover:font-semibold transition-all ease-linear duration-200">Shop Now <GoArrowRight className="text-2xl" /></Link>
        </div>
    </div>);
}