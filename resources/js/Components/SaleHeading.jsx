    ...
    return (
        <div className="w-full bg-zinc py-3 px-20">
            <div className="w-full flex flex-row justify-between items-center">
                ...
                <div><h6 className="font-poppins text-white text-base">Sign up and GET 25% OFF for your first order. <Link href={'#'} className="underline text-mustard">Signup up now</Link></h6></div>
